...
<head>
    ...
    <title>INSPINIA - Administrator Page</title>
</head>
                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="font-bold text-navy">44% <i
                                    class="fa fa-level-up"></i> <small>Rapid pace</small></div>
                        </div>

                        <div class="col-md-6">
                            <h1 class="no-margins">206,12</h1>

                            <div class="font-bold text-navy">22% <i
                                    class="fa fa-level-up"></i> <small>Slow pace</small></div>
                        </div>
                    </div>
                ...
                <div class="ibox-content">
                    <div>
                        <span class="pull-right text-right">
                            <small>Average value of sales in the past month in: <strong>United states</strong>
                            </small>
                            <br/>
                            All sales: 162,862
                        </span>
...
<content tag="script">
    ...
    <asset:javascript src="flot/jquery.flot.tooltip.min.js"/>
    <asset:javascript src="flot/jquery.flot.symbol.js"/>

    <!-- Peity -->
    <asset:javascript src="jquery.peity.min.js"/>
    <asset:javascript src="peity-demo.js"/>
